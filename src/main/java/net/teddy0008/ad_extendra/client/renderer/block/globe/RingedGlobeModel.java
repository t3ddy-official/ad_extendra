...
public class RingedGlobeModel extends Model {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Main.MOD_ID, "ringed_globe"), "main");
    private final ModelPart globe;

    public RingedGlobeModel(ModelPart root) {
    ...
    public static RingedGlobeModel getModel() {
        return new RingedGlobeModel(Minecraft.getInstance().getEntityModels().bakeLayer(LAYER_LOCATION));
    }
