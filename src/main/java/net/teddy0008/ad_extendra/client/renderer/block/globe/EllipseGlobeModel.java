...
public class EllipseGlobeModel extends Model {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Main.MOD_ID, "ellipse_globe"), "main");
    private final ModelPart globe;

    public EllipseGlobeModel(ModelPart root) {
    ...
    public static EllipseGlobeModel getModel() {
        return new EllipseGlobeModel(Minecraft.getInstance().getEntityModels().bakeLayer(LAYER_LOCATION));
    }
