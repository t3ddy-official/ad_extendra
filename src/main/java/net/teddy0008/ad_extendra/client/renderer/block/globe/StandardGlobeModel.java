...
public class StandardGlobeModel extends Model {
    ...
    public StandardGlobeModel(ModelPart root) {
    ...
    public static StandardGlobeModel getModel() {
        return new StandardGlobeModel(Minecraft.getInstance().getEntityModels().bakeLayer(LAYER_LOCATION));
    }
