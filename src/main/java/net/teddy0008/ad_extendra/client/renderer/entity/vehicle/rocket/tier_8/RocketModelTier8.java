...
public class RocketModelTier8 extends VehicleModel<RocketTier8> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Main.MOD_ID, "tier_8_rocket"), "main");

    public RocketModelTier8(ModelPart root) {
        super(root, "rocket");
    }
