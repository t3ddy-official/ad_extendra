...
public class SidewaysRingedGlobeModel extends Model {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Main.MOD_ID, "sideways_ringed_globe"), "main");
    private final ModelPart globe;

    public SidewaysRingedGlobeModel(ModelPart root) {
    ...
    public static SidewaysRingedGlobeModel getModel() {
        return new SidewaysRingedGlobeModel(Minecraft.getInstance().getEntityModels().bakeLayer(LAYER_LOCATION));
    }
