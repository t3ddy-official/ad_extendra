...
public class RocketModelTier9 extends VehicleModel<RocketTier9> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Main.MOD_ID, "tier_9_rocket"), "main");

    public RocketModelTier9(ModelPart root) {
        super(root, "rocket");
    }
