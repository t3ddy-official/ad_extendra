...
public class RocketModelTier6 extends VehicleModel<RocketTier6> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Main.MOD_ID, "tier_6_rocket"), "main");

    public RocketModelTier6(ModelPart root) {
        super(root, "rocket");
    }
